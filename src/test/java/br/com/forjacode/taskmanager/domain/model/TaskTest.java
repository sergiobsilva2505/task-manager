...
class TaskTest {
    ...
    class Success {
        ...
        void shouldCreateTaskWithValidData() {
            ...
            Task task = Task.create("Pay bills", "Monthly bills", Priority.HIGH, dueDate);
    ...
    class WithError {
        ...
        void shouldThrowExceptionWhenDueDateIsNull() {
            assertThatThrownBy(() -> Task.create("Task", "description", Priority.MEDIUM, null))
                    .isInstanceOf(MissingRequiredFieldException.class)
    ...
    class StatusTransition {
        ...
        void shouldChangeStatusFromTodoToInProgress() {
            Task task = Task.create("Task", "description", Priority.LOW, LocalDateTime.now().plusDays(1));
    ...
    class Reconstruction {
        ...
        void shouldReconstructTaskWithPersistedData() {
            ...
            Task task = Task.reconstruct(id, "Task", "description", Status.IN_PROGRESS, Priority.HIGH, dueDate, createdAt, updatedAt);
