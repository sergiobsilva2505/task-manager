...
public interface AuthApiSwagger {
    ...
    @ApiResponse(responseCode = "401",
            description = "E-mail não cadastrado ou senha incorreta (mesma resposta genérica nos dois casos)",
            content = @Content(schema = @Schema(implementation = ProblemDetail.class)))
    ...
    @ApiResponse(responseCode = "200",
            description = "Login bem-sucedido (identidade existente, vinculada, ou usuário novo criado)")
    @ApiResponse(responseCode = "400", description = "idToken ausente ou em branco",
            content = @Content(schema = @Schema(implementation = ProblemDetail.class)))
    @ApiResponse(responseCode = "401",
            description = "Token do Google inválido, expirado, ou não emitido para este aplicativo",
            content = @Content(schema = @Schema(implementation = ProblemDetail.class)))
