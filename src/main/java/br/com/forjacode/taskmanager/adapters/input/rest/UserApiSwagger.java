...
public interface UserApiSwagger {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Campos ausentes/inválidos: nome fora do formato/tamanho esperado, " +
                    "e-mail em formato inválido, ou senha sem os requisitos mínimos de força",
